lst_main_item = ['#!/accessories/head', '#!/accessories/face', '#!/accessories/neck', 
...
lst_first_item = ['#!/accessories/head', '#!/accessories/face', '#!/accessories/neck', 
'#!/accessories/shoulder', '#!/accessories/front', '#!/accessories/back', 
'#!/accessories/waist', '#!/accessories/gear', '#!/animations/animations', 
'#!/audio/audio', '#!/avatar-animations/run', '#!/avatar-animations/walk', 
'#!/avatar-animations/fall', '#!/avatar-animations/jump', '#!/avatar-animations/idle', 
...
'#!/decals/decals', '#!/emote-animations/emotes', '#!/faces/faces', '#!/hair-accessories/hair', '#!/head/heads', 
'#!/meshparts/meshes', '#!/models/models', '#!/game-passes/passes','#!/private-servers/my-private-servers', 
'#!/private-servers/other-private-servers', '#!/shoes/left-shoe', '#!/shoes/right-shoe']
